...
| Valvola | SONOFF SWV (Zigbee) — **non ancora collegata** |
| Dongle Zigbee | Sonoff ZBDongle-P (USB sul RPi5) |
...
| `zigbee2mqtt` | `koenkk/zigbee2mqtt:latest` | 8080 | Bridge Zigbee (non ancora attivo) |
...
Node-RED <--> zigbee2mqtt/SWV_valvola (Zigbee, step 3)
```
...
| 3 | SONOFF SWV + Zigbee2MQTT — valvola via MQTT | ⏳ Prossimo |
